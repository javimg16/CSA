/* 
 * Se crea una peticion ajax para que muestre los usuarios
 */
...
var conexion;
    ...
    function peticion(){
        ...
        conexion.open("POST", "Controllers/admin/usuarios/busqueda.php");
    ...
    function formulario(){
        ...
        celda11.innerHTML = "<label>Usuario</label>";
        var celda12 = document.createElement("td");
        celda12.innerHTML = "<input type=\"text\" name=\"usuario\" />";
        ...
        legend.innerHTML = "Resultado Busqueda Usuarios";
