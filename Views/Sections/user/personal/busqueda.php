        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="button" value="Borrar" id="borrar" class="ui-button ui-widget ui-corner-all" /></td>
                    <td><input type="button" value="Cartilla de Vuelos" id="cartilla" class="ui-button ui-widget ui-corner-all" /></td>
                </tr>
            </table>
        </fieldset>
    </form>
